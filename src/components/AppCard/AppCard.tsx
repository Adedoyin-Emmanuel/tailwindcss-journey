...
const AppCard = ({
  ...
  return (
    <section
      className={`card-section border border-slate-600 rounded-lg mx-5 p-4 flex flex-col justify-center md:w-auto ${className} hover:border-violet-200 cursor-pointer transition-all duration-100 mb-14`}
      {...others}
    >
