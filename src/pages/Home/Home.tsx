...
const Home = (): JSX.Element => {
  return (
    <section className=" w-full h-screen bg-gradient-to-bl from-black to-blue-950 overflow-x-hidden">
      ...
      <AppHero>
        <h2 className="md:mx-auto text-left mx-5 md:text-center text-3xl md:text-6xl capitalize font-bold bg-clip-text text-transparent bg-gradient-to-br from-sky-300 to-violet-500 ">
          Hi Everyone,
